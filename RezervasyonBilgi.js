...
export default class RezervasyonBilgi extends Component {
  ...
  verigetir = () => {
    Axios.get("http://localhost:3001/rezervasyonbilgi")
      .then(res => {
  ...
  odanogonder = (event) => {
    ...
    if (oda.odano === "") {
      ...
      Axios.post("http://localhost:3001/rezervasyonbilgino", { oda_no: oda })
        .then(res => {
          const odabilgi = res.data;
          this.setState({ odabilgi });
        })
  ...
  giristarih = (event) => {
    ...
    Axios.post("http://localhost:3001/rezervasyonbilgioz", { odaoz: oda })
      .then(res => {
        const odabilgi = res.data;
